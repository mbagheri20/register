...
if($try_send){
  ...
  $mail->setFrom('mohammad.bagheri@oulu.fi', 'Physics Boat Workshop');
  $mail->addReplyTo('mohammad.bagheri@oulu.fi', 'Physics Boat Workshop');
  ...
  $mail->addAddress('mohammad.bagheri@oulu.fi', 'abstract submission');
...
You have successfully registered to the Physics Boat 2024 workshop with the following information.
...
';
  ...
  $mail2->Port = 25;	
  $mail2->isHTML(true);
  $mail2->setFrom('mohammad.bagheri@oulu.fi', 'Physics Boat Workshop');
  $mail2->addReplyTo('mohammad.bagheri@oulu.fi', 'Physics Boat Workshop');
